                        ...
                        <div class="row gy-4 custom-class-fare mt-3">
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    <input type="number" class="form-control part-1-input copy-value"
                                           step=".01" min="0.01" name="base_fare" id="base_fare" max="99999999"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    <input type="number" class="form-control part-1-input copy-value" step=".01" min="0.01" max="99999999"
                            ...
                            <div class="col-sm-6 col-lg-4">
                                ...
                                <div class="input-group_tooltip">
                                    <input type="number" name="min_cancellation_fee" step=".01" min="0" max="99999999"
                                           class="form-control part-1-input copy-value"
                                    ...
                                    <table class="table align-middle table-borderless table-variation">
                                        ...
                                        <tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0.01" max="99999999"
                                                           name="base_fare_{{$vehicleCategory->id}}"
                                                           class="form-control base_fare_default part-2-input {{$vehicleCategory->id}}"
                                                           value="{{ $trip?->base_fare ? round($trip->base_fare, 2) : 0 }}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'readonly'  }} required>
                                                </td>
                                            @empty
                                            @endforelse
                                        ...
                                        <tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                @php($trip = $tripFares?->firstWhere('vehicle_category_id', $vehicleCategory->id))
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min=".01" max="99999999"
                                                           name="base_fare_per_km_{{$vehicleCategory->id}}"
                                                           class="form-control base_fare_per_km_default part-2-input {{$vehicleCategory->id}}"
                                                           value="{{$trip?->base_fare_per_km ? round($trip->base_fare_per_km , 2) :  0}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'readonly'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0" max="100"
                                                           ...
                                                           class="form-control cancellation_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'readonly'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0" max="99999999"
                                                           ...
                                                           class="form-control min_cancellation_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'readonly'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0" max="99999999"
                                                           ...
                                                           class="form-control idle_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'readonly'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
                                            ...
                                            @forelse($vehicleCategories as $vehicleCategory)
                                                ...
                                                <td class="{{$vehicleCategory->id}} {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'d-none'  }}">
                                                    <input type="number" step=".01" min="0" max="99999999"
                                                           ...
                                                           class="form-control trip_delay_fee_default part-2-input {{$vehicleCategory->id}}" {{ $vehicleCategory->id == $trip?->vehicle_category_id ? '':'readonly'  }}>
                                                </td>
                                            @empty
                                            @endforelse
                                        </tr>
